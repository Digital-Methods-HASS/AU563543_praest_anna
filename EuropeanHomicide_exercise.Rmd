...
ggplot(Western_Europe, aes(x = Year, y = homicides_per_100k)) +
  geom_line() +
  labs(title = "Homicide Rate per 100k over Time in Western Europe",
       x = "Year",
...
```{r plot-homocides_split_percountry, eval = TRUE}
ggplot(Western_Europe, aes(x = Year, y = homicides_per_100k)) +
  geom_line() +
  labs(title = "Homicide Rate per 100k over Time in Western Europe",
       x = "Year",
...
#in homocides is seen a decrease over time, whereas duration of reign among danish kings show an overall increase
```
...
ggplot(Western_Europe, aes(x = Year, y = homicides_per_100k, color = Entity)) +
  ...
  labs(title = "Homicide Rate per 100k over Time in Western Europe",
       ...
       y = "Homicide Rate per 100k") +
  facet_wrap(~ Entity, ncol = 1) +
  theme(legend.position = "bottom") +  #moving legend below the facets
  guides(color = guide_legend(title = "Country"))  #changing legend title to country
